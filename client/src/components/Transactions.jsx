...
return (
    ...
    ">
        <div className="flex flex-col items-center w-full mt-3">
            <div className="display-flex justify-start w-9/12 mt-3">
            ...
            <img src={gifUrl} alt="nature"
            className="w-full h-64 2xl:h-96 rounded-md shadow-lg object-cover" />
            <div className="flex text-ellipsis  bg-black p-3 px-5 w-max rounded-3xl mt-5 shadow-2xl">
                <p className="truncate text-[#37c7da] font-bold">{timeStamp}</p>
            </div>
        </div>
    </div>
)
