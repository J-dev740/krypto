      ...
      <div className="flex w-full justify-center items-center">
        <div className="flex mf:flex-row  items-start justify-between md:p-20 py-12 px-4">
          ...
          <div className=" flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
            <div className="p-3 flex justify-between flex-col items-start  rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism">
              {/* <div className="flex justify-between flex-col w-full h-full"> */}
                <div className="flex flex-row justify-between border-0 w-full  items-start">
                  <div className="w-10 h-10 rounded-full border-2 border-white-700 flex justify-center items-center">
